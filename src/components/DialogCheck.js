...
export default ({ dialogVisible, closeDialog, item, checkItem }) => {
    ...
    return (
        <Portal>
            <Dialog
                ...
                dismissable={false}>
                <Dialog.Title>
                    <Title style={styles.title}>{item.nome} - Quantidade ({item.grandeza}) verificada:</Title>
                </Dialog.Title>
                <Dialog.Content>
                    <Item floatingLabel>
